...
export const GLOBAL_COOPERATION = [
  {
    id: 1,
    title: "A Path to Utopia",
    items: [
      {
        id: 1,
        title: "The Emerging Importance of AI Alignment and Control",
        description:
          "Highlighting the significant role of artificial intelligence in our lives, and the need for these systems to align with human values and ethical principles.",
      },
      {
        id: 2,
        title: "Introducing GATO",
        description:
          "Unveiling the Global Alignment Taxonomy Omnibus, a comprehensive framework designed to solve AI alignment and control issues.",
      },
      {
        id: 3,
        title: "A Multidimensional Approach",
        description:
          "Showcasing GATO's unique multi-layered approach, encompassing everything from model alignment and system architecture to corporate policies and international agreements.",
      },
      {
        id: 4,
        title: "The Power of Global Cooperation",
        description:
          "Promoting GATO's commitment to fostering global consensus and cooperation in addressing AI challenges.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          "Underlining our mission to create a fully decentralized and federated method to solve AI alignment and control problems.",
      },
      {
        id: 2,
        title: "Easy Access and Dissemination",
        description:
          "Highlighting our commitment to making the GATO Framework easily understandable, adoptable, and sharable through the provision of documents, data, code, and multimedia.",
      },
      {
        id: 3,
        title: "Ethical AI Systems",
        description:
          "Stressing our goal to ensure AI systems remain ethically grounded, transparent, and controllable.",
      },
      {
        id: 4,
        title: "A Brighter Future",
        description:
          "Promoting our vision of ushering in a new era of peace, stability, abundance, and prosperity for all through addressing AI alignment and control issues.",
      },
    ],
  },
];

export const GATO_LAYERS = [
  {
    id: 1,
